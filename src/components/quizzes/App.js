          ...
          <div className="quiz-card card p-3 text-center">
            ...
            <div className="d-flex justify-content-center">
              <button
                ...
                onClick={() => setSelectedQuiz({ type: "pickPeriod", difficulty: "easy" })}
              >
                Easy
              </button>
              <button
                className="btn btn-primary mx-2 quiz-option"
                onClick={() => setSelectedQuiz({ type: "pickPeriod", difficulty: "medium" })}
              >
                Medium
              </button>
              <button
                className="btn btn-primary mx-2 quiz-option"
                onClick={() => setSelectedQuiz({ type: "pickPeriod", difficulty: "hard" })}
              >
                Hard
              </button>
            </div>
        ...
        <div className="col-md-8">
          <div className="quiz-card card p-3 text-center">
            ...
            <div className="d-flex justify-content-center">
              <button
                className="btn btn-primary mx-2 quiz-option"
                onClick={() => setSelectedQuiz({ type: "guessImage", difficulty: "easy" })}
              >
                Easy
              </button>
              <button
                className="btn btn-primary mx-2 quiz-option"
                onClick={() => setSelectedQuiz({ type: "guessImage", difficulty: "medium" })}
              >
                Medium
              </button>
              <button
                className="btn btn-primary mx-2 quiz-option"
                onClick={() => setSelectedQuiz({ type: "guessImage", difficulty: "hard" })}
              >
                Hard
              </button>
            </div>
